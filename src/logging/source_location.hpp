...
#ifndef RDSS_LOGGING_SOURCE_LOCATION_H_
#define RDSS_LOGGING_SOURCE_LOCATION_H_
...
// not in the rdss namespace to make it easier to search/replace migrate usages
