...
#ifndef RDSS_LOGGING_LOG_ENTRY_H_
#define RDSS_LOGGING_LOG_ENTRY_H_
...
public:
  ...
  // Format this `LogEntry` as it should appear in a log file.
  // Most `LogSink::Send` overrides should use this method to obtain a
  // log string.
