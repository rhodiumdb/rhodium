...
#ifndef RDSS_FILESYSTEM_TEMP_DIRECTORY_H_
#define RDSS_FILESYSTEM_TEMP_DIRECTORY_H_
...
class TempDirectory {
 public:
  ...
  //   ASSIGN_OR_RETURN(TempDirectory dir, TempDirectory::Create());
...
#endif  // RDSS_FILESYSTEM_TEMP_DIRECTORY_H_
